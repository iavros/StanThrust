        ...
        state.update(
            {
                ...
                "target_chamber_pressure_kpa": self.reference_chamber_pressure_kpa,
    ...
    return [
        InternalBaselineCase(
            ...
            expected_ranges={
                ...
                "nozzle_expansion_ratio": [2.9, 3.8],
                "total_stack_length_mm": [835.0, 930.0],
                "thermal_margin_index": [95.0, 100.0],
            },
            note="Baseline pressure-fed sample with automatic nozzle exit sizing used for ordinary StanThrust regression checks.",
        ),
        InternalBaselineCase(
            ...
            expected_ranges={
                ...
                "nozzle_expansion_ratio": [3.4, 4.5],
                "total_stack_length_mm": [990.0, 1110.0],
                "thermal_margin_index": [95.0, 100.0],
            },
            note="Midscale pump-fed case used to detect drift in pressure closure, cooled geometry sizing, and automatic nozzle expansion.",
        ),
        InternalBaselineCase(
            ...
            expected_ranges={
                ...
                "nozzle_expansion_ratio": [3.4, 4.5],
                "total_stack_length_mm": [1440.0, 1605.0],
                "thermal_margin_index": [95.0, 100.0],
            },
            note="Large pressure-fed case used to guard film-cooling, packaging behavior, and automatic nozzle expansion at larger scales.",
        ),
    ]
